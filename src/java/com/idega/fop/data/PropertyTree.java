/*
 * $Id: PropertyTree.java,v 1.5 2007/12/03 15:07:21 laddi Exp $
...
public class PropertyTree implements Property {
	...
	public PropertyTree add(String key, String description, String value, String description2, String value2, String description3, String value3, String unit) {
		Property property = new ThreeValuePropertyWithUnit(key, description, value, description2, value2, description3, value3, unit);
		this.value.add(property);
		return this;
	}
